...
### Purpose
An intriguing thought motivates this work: there is likely a recipe that can determine an appropriate daily cost for an Airbnb based on typical property features, location, amenities, and overall experience ratings. This project attempts the following:
